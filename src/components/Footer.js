...
const Footer = () => {
  return (
    <div className='flex justify-center py-[1rem] border-t-2 border-b-2 border-t-gray-300 border-b-gray-300 text-gray-600 bg-[#081429]'>
      <div className='flex justify-between w-[85%] text-[white]'>
        ...
        <div className='justify-between flex text-[.9rem]'>
          <div className='flex flex-col items-start  w-[11rem]  justify-between'>
            <p>CONTACT INFO</p>
