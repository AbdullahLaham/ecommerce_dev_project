  ...
  return (
    ...
    .8   nav.map((item) => {
        ...
        <div className={`flex flex-col items-center justify-center h-[100%] max-h-[100%] min-h-[100%] w-[20%]  relative text-gray-600 ${'Wishlist' == selected ? 'mb-[1.3rem]' : ''}`}>
                <p onClick={() => {setSelected('Wishlist'); navigate('/dashboard/wishlist')}} className={`text-[1rem]  ${'Wishlist' == selected ? 'p-[.6rem] bg-orange-500 text-white rounded-[50%] ' : ''}`}><FavoriteBorderIcon sx={{fontSize: '2rem',}}  /></p>
