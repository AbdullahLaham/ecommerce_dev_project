...
const SidebarComponent = ({showAccountSidebar, setShowAccountSidebar}) => {
  ...
  return (
    <div className={`w-[100%] h-[100vh] max-h-[100vh] z-20 absolute top-0  bg-white flex-col justify-between backdrop-blur	 ${showAccountSidebar ? 'left-0 right-0 boxshadow-style flex' : '-left-[100%] hidden'} ease-in-out delay-150`}>
      <div>
